...
@TypeAlias("OrderProcessed")
public class OrderProcessed extends OrderEvent {

    public OrderProcessed(UUID id, Id entityId, LocalDateTime eventCreateTime) {
        super(id, entityId, eventCreateTime);
    }

    @Override
    protected Order applyToOrder(Order entity) {
        return entity.process(this.getEventCreateTime());
    }
